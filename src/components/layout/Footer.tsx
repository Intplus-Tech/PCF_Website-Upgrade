...
function SocialIcon({ label, href, children }: { label: string; href: string; children: React.ReactNode }) {
  return (
    <a
      ...
      className="text-wine-700 transition-opacity hover:opacity-70"
    >
      {children}
    </a>
  );
        ...
        <div className="grid gap-10 lg:grid-cols-[auto_1fr_1fr_1fr_1fr] lg:gap-8 -ml-32">
          ...
          <div>
            ...
            <div className="mt-4 flex items-center gap-3">
              <SocialIcon label="YouTube" href={site.socials.youtube}>
              ...
              <SocialIcon label="Instagram" href={site.socials.instagram}>
              ...
              <SocialIcon label="Facebook" href={site.socials.facebook}>
