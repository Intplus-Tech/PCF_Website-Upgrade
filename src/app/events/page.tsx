    ...
    <>
      ...
      <section className="py-20 lg:py-24 bg-[#FFFFFF]">
        ...
        <div className="mt-12 grid gap-8 lg:grid-cols-[1fr_auto] lg:items-stretch">
              ...
              <div className="mt-4 space-y-4">
                {events.map((event) => {
                  ...
                  return (
                    <div
                      key={event.id}
                      className="grid grid-cols-[auto_1fr_auto] items-center gap-4 rounded-md border border-ink/10 px-5 py-4"
                    >
            ...
            {/* Side image */}
            <div className="relative h-64 w-full overflow-hidden rounded-md lg:h-full lg:w-80">
              <Image
