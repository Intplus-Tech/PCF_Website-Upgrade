    ...
    <>
      ...
      <section className="overflow-hidden py-12 lg:py-16">
        <Container size="wide">
          ...
          {/* Featured series — image left, text right */}
          <div className="mt-10 grid items-center gap-10 lg:grid-cols-2">
            <Reveal direction="left">
              <div className="shine relative aspect-[4/3] overflow-hidden rounded-xl">
            ...
            <Reveal direction="right">
              <div>
                ...
                <h2 className="mt-4 max-w-md font-body text-3xl font-extrabold leading-tight text-ink sm:text-4xl">
                  <RevealText text="Discovering Light in the Darkness" />
                </h2>
            ...
            <Reveal direction="left" className="lg:order-1">
              <div>
                ...
                <h2 className="mt-4 font-body text-3xl font-extrabold leading-tight text-ink sm:text-4xl">
                  <RevealText text="Foundational Principals of Faith" />
                </h2>
                <p className="mt-4 leading-relaxed text-muted">
