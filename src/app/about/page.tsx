...
export default async function AboutPage() {
  ...
  return (
    ...
    />
      ...
      {/* Section 1 — We Preach the Gospel (image + quote card, text right) */}
     <section className="py-24 lg:py-32">
      ...
      {/* Section 2 — Why We Exist (mission + values list) */}
     <section className="py-24 lg:py-32">
      ...
      {/* Section 3 — Pastor David (full-bleed image with text overlay) */}
      ...
      {/* Section 4 — Be Part of Our Story (centered text) */}
     <section className="py-24 lg:py-32">
