    ...
    <>
      ...
      <div style={{ backgroundColor: "#F5F5F5" }}>
        <section className="relative isolate overflow-hidden">
          ...
          <Container className="flex min-h-[78vh] flex-col justify-center space-y-6 pb-20 pt-56 text-cream-50 sm:pt-52 lg:pt-64">
  ...
  <Container size="full">
    <div className="relative">
      <Reveal direction="left">
        ...
        <Float className="relative z-10 mx-4 -mt-20 lg:absolute lg:right-0 lg:top-[75%] lg:mx-0 lg:mt-0 lg:w-[40%] lg:-translate-y-1/2">
  <Link
    href="/about"
    className="group block border border-wine-700/10 bg-cream-50 p-8 shadow-xl transition-all hover:border-wine-700/30 hover:shadow-2xl lg:min-h-[520px] lg:p-12"
  >
    <span className="block h-0.5 w-10 bg-ink/70" />
    <h2 className="mt-6 font-body font-bold leading-tight tracking-[-1.05px] text-ink text-[32px] lg:text-[41.96px] lg:leading-[52.45px]">
  ...
  <Container size="full">
    <div className="relative">
      <Reveal direction="right">
        ...
        <Float className="relative z-10 mx-4 -mt-20 border border-wine-700/10 bg-cream-50 p-8 shadow-xl lg:absolute lg:left-0 lg:top-[45%] lg:mx-0 lg:mt-0 lg:w-[40%] lg:-translate-y-1/2 lg:min-h-[520px] lg:p-12">
  <span className="block h-0.5 w-10 bg-ink/70" />
  <h2 className="mt-6 font-body font-bold leading-tight tracking-[-1.05px] text-ink text-[32px] lg:text-[41.96px] lg:leading-[52.45px]">
